...
(function() {
  var App, Clock, Main, Sidebar, app, catZero, extract_values, field_style, getType, main_sz, menu_style, render_time, side_col, states, template;
  ...
  App = (function() {
    ...
    App.prototype.render = function() {
      var all_ids, clock, i, len, main, main_clocks, sidebar;
      all_ids = template.callInfo.ids.concat(template.cxInfo.ids, template.notes.ids, template.diagResults.ids, template.conclusions.ids);
      main = new Main("#main");
      ...
      sidebar.render();
      main.render();
      this.getValues(template.conclusions, "#conclusions_btn");
      return this.getValues(all_ids, '#ts_steps_btn');
    };

    App.prototype.getValues = function(section, button) {
      return $(button).click(function() {
        console.log(extract_values((function() {
        ...
        return console.log(getType(section));
      });
    };
