...
(function() {
  var App, Clock, Main, Sidebar, app, catZero, checkboxHandler, days, extract_values, field_style, getType, isBlank, isChecked, main_sz, menu_style, months, render_time, side_col, states, template;
  ...
  App = (function() {
    ...
    App.prototype.render = function() {
      ...
      return this.getField('#symptoms', '#symptoms_btn');
    };
